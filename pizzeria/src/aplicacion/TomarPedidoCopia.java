...
public class TomarPedidoCopia extends javax.swing.JPanel {

    Calendar calendario;
    int dia, mes, año, hora, minutos, segundos;
    private static TomarPedidoCopia myInstance;

    public TomarPedidoCopia() {
        initComponents();
    ...
    public static TomarPedidoCopia getInstance(){ 
        if (myInstance == null) 
        myInstance = new TomarPedidoCopia(); 
        return myInstance; 
    }
    ...
    public void setArticuloTabla1(String cantidad, String catalogo, String producto, String precio, String total) {
        try {
            String[] registro = new String[7];

            txt_nombre.setText("bvbrbufbfgubugfubu   "+producto);
            registro[0] = cantidad;
            registro[1] = cantidad;
            registro[2] = catalogo;
            registro[3] = catalogo;
