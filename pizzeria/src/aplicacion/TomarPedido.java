...
public class TomarPedido extends javax.swing.JPanel {
    ...
    private static TomarPedido myInstance;
...
//            jcCatalogo.addItem(item);
    ...
    public static TomarPedido getInstance(){ 
        if (myInstance == null) 
        myInstance = new TomarPedido(); 
        return myInstance; 
    }
...
//        txt_idpedido.setVisible(false);
    ...
    public void setArticuloTabla(String cantidad, String catalogo, String id, String producto, String precio, String total) {
        try {
    ...
    void calcularTotal() {
        ...
        txt_total.setText(formateador.format(total).toString());
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_nombre, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btn_cancelarTodo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_cancelarTodoActionPerformed(evt);
            }
        });
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btn_cancelarTodo, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        setArticuloTabla(cantidad, catalogo, producto, precio, total);
        pedido.Pedido pd = new pedido.Pedido(new javax.swing.JFrame(), true);
        pd.setVisible(true);
